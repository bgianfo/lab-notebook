...
pros and cons. [Kees Cook](https://twitter.com/kees_cook) has a nice writeup on
...
It appears to me that `-fstack-protector-strong` would be a good compromise for
use in Serenity OS.
...
## Testing
Now that we have the system compiling, lets write test program to make sure we
...
The resulting pull request is here: 
